...
experiment Episode1_Mask type: gui parent: Coronaizer{
	...
	init
	{   
		create simulation with: [episode::1,title::"Mask 50% ",useCase::"UDG/CUCS/Level 2",useCaseType::"Classrooms",
		ventilationType::"Natural",ventilation_ratio::0.0,
		timeSpent::1.0#h,density_scenario::'distance',distance_people::1.0#m,maskRatio::1.0,queueing::false, peopleSize::0.3#m , agenda_scenario::"simple",
...
experiment Episode1_Social_Distancing type: gui parent: Coronaizer{
	...
	{   
		create simulation with: [episode::1,title::"Mask 50% ",useCase::"UDG/CUCS/Level 2",useCaseType::"Classrooms",
		ventilationType::"Natural",ventilation_ratio::0.0,
		timeSpent::1.0#h,density_scenario::'distance',distance_people::2.5#m,maskRatio::0.0,queueing::false, peopleSize::0.3#m , agenda_scenario::"simple",
		arrival_time_interval:: 3#mn, step_arrival::1#s];
