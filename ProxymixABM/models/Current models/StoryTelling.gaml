...
experiment Episode1 type: gui parent: Coronaizer{
	...
	{   
		...
		timeSpent::45#mn,density_scenario::"distance",distance_people::2.0#m,maskRatio::0.7,queueing::false, peopleSize::0.3#m , agenda_scenario::"simple"];
	}
}


experiment Episode1Bis type: gui parent: Coronaizer{
	//Scenario 1
	parameter 'title:' var: title category: 'file' <- "Scenario A: No intervention";
	parameter 'fileName:' var: useCase category: 'file' <- "UDG/CUCS/Campus";
	parameter 'useCaseType:' var: useCaseType category: 'file' <- "Classrooms and Offices";
	parameter 'ventilationType:' var: ventilationType category: 'file' <- "Natural";
	parameter 'timeSpent:' var: timeSpent category: 'file' <- 3.0 #h;
	...
	init
	{   
		create simulation with: [title::"Scenario B: Mask and Social Distancing",useCase::"UDG/CUCS/Campus",useCaseType::"Classrooms and Offices",ventilationType::"Natural",
		timeSpent::45#mn,density_scenario::"distance",distance_people::2.0#m,maskRatio::0.7,queueing::false, peopleSize::0.3#m , agenda_scenario::"simple"];
	}
}
